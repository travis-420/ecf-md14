...
2. **Full-likelihood analysis:** if a CAMB/Cobaya-level analysis with the complete Planck likelihood (replacing the compressed priors) erases the Δχ² preference, the result reported here is void.
